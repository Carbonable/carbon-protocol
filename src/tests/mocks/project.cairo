...
mod project {
    ...
    impl ERC721 of IERC721<ContractState> {
        ...
        fn ownerOf(self: @ContractState, tokenId: u256) -> ContractAddress { contract_address_try_from_felt252(1).unwrap() }
        ...
        fn getApproved(self: @ContractState, tokenId: u256) -> ContractAddress { contract_address_try_from_felt252(1).unwrap() }
        ...
        // IERC721Enumerable
        fn totalSupply(self: @ContractState) -> u256 { 1000_u256 }
    ...
    impl Project of IProjectLegacy<ContractState> {
        ...
        fn getFinalTime(self: @ContractState, slot: u256) -> u64 { 10 }
        ...
        fn getAbsorption(self: @ContractState, slot: u256, time: u64) -> u64 { 1000000 }
        fn getCurrentAbsorption(self: @ContractState, slot: u256) -> u64 { 3000000 }
        fn getFinalAbsorption(self: @ContractState, slot: u256) -> u64 { 5000000 }
        fn getTonEquivalent(self: @ContractState, slot: u256) -> u64 { 1000000 }
        fn getProjectValue(self: @ContractState, slot: u256) -> u256 { 100 }
